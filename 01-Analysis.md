...
More formally, a subsequence of $\{ a_n\}$ is a sequence $\{ b_k\}$ defined by $b_k = a_{n_k}$, where $n_1 < n_2 < \ldots$ is an increasing sequence of indices. Let $a_n = 1,2,3,\ldots = n$. Let $\{ b_k\} = 1,0,1,0,\ldots = \frac{(-1)^n + 1}{2}$. It is evident that $\{ b_k\}$ does not satisfy the definition of subsequence for $\{ a_n\}$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1NzQ3MDM4NCwtNDUxMzk3OTg1LC04ND
EyMzg5NjcsLTEyNzU4NzYzNiwxNTg0OTk5NDk0LDE0MTU2NDIz
ODMsLTEyNzU4NzYzNiwxMDAyNzQwOTgzXX0=
-->