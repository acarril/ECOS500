...
More formally, a subsequence of $\{ a\}$ is a sequence $\{ b\}$ defined by $b_k = a_{n_k}$, where $n_1 < n_2 < \ldots$ is an increasing sequence of indices. Let $a$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0NTI3MzI5NywtNDUxMzk3OTg1LC04ND
