...
**Solution:** Let $S_{n_k} \rightarrow L$. We need to show that $\forall \epsilon > 0, \exists N$ s.t. $d(S_i, L) < \epsilon \forall i$
18. 
19. f
20. f
21. f
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjM4OTMxNDc0LDYzMjg5NzI4MCwxNTM5Nz
U0OTY3LDE4NzE2NDI4NTRdfQ==
-->