...
Since $l_1$ is a limit of $\{ s_n\}_{n \in \mathbb{N}}$ we can apply the definition of limit with our choice of $\epsilon$
5. 
6. f
7. f
8. f
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NTI4ODkzODEsLTE5MTAyMDU1NjFdfQ
==
-->